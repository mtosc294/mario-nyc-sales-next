...
export function LanguageSwitcher() {
  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        type="button"
        className="inline-flex items-center gap-1.5 rounded-sm border border-[var(--platinum)]/45 px-2.5 py-2 text-sm transition hover:border-white hover:bg-white/5"
        aria-expanded={open}
      ...
      {open ? (
        <div
          className="absolute right-0 top-full z-[60] mt-2 min-w-[280px] border border-[var(--line)] bg-white text-[var(--ink)] shadow-[0_18px_40px_rgba(16,27,45,0.14)]"
          role="listbox"
          aria-label={t("label")}
        >
